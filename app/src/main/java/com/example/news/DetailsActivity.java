...
public class DetailsActivity extends AppCompatActivity {
   ...
   ImageView img_news;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_title = findViewById(R.id.text_desc_title);
        txt_details = findViewById(R.id.text_desc_full);
        txt_time = findViewById(R.id.text_desc_published);
        txt_author = findViewById(R.id.text_desc_source);
